...
import { getProduct, getProductByName } from "../../../store/actions/productActions";
...
class ProductModify extends Component {
  ...
  render() {
    ...
    const processors = [
      { label:`${ProductHelper.getSpecs(product.processor)}`, value:`${ProductHelper.getSpecs(product.processor)}` },
        ...
        <div className="checkout-wrap pt-30">
                    <div className="row">
                                ...
                                <div className="row">
                                    <div className="col-lg-12">
                                        <div className="billing-info mb-20 ">
                                            <label>Model <abbr className="required" title="required">*</abbr></label>
                                            <ReactSelect
                      ...
                      ></ReactSelect>
                                    ...
                                    <div className="col-lg-12">
                                        <div className="billing-info mb-20">
                                            <label>Processor<abbr className="required" title="required">*</abbr></label>
                                            <SelectListGroup
                          name="view"
                          value={ProductHelper.getSpecs(product.processor)}
